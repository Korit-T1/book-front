...
function ReturnedPageNumbers(data) {
                ...
                <div css={s.pageNumbers}>
                    {page !== 1 && totalCount !== 0 && (
                        <Link
                            ...
                            to={`/mypage/returned?page=${page - 1}&filter=${filter}`}
                        >
                            &#60;
                        </Link>
                    )}
                    {numbers.map((number) => (
                        <Link
                            ...
                            to={`/mypage/returned?page=${number}&filter=${filter}`}
                        >
                            {number}
                        </Link>
                    ))}
...
export default ReturnedPageNumbers;